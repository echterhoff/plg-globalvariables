...
//import('joomla.form.formfield');

/**
 * Form Field class for the Joomla Platform.
 * Display a JSON loaded window with a blockrepeat set of sub fields
 *
 * @package     Joomla.Platform
 * @subpackage  Form
 * @since       3.2
 */
class JFormFieldBlockrepeat extends JFormField
{
	/**
	 * The form field type.
	 *
...
//        $this->element['filter']->addAttribute('filter', 'raw');
//        exit;
...
//    }
	...
	protected function getInput()
	{
		...
		{
//            //Promote filter to the Repeatable element
//            if(isset($field->element['filter']) && !isset($this->element['filter']) && $field->element['filter']){
//                $this->element->addAttribute('filter', $field->element['filter'][0]);
//            }
		...
		$data[] = 'data-blockrepeat-element="table tbody tr"';
		...
		$str[] = '<input type="hidden" name="' . $this->name . '" id="' . $this->id . '" value="' . $value . '"  class="form-field-blockrepeat" ' . implode(' ', $data) . ' />';
